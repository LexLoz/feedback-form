...
P.S.
It was a bit broken so I edited it a little (line 54)
I guess that's why I couldn't download this package from npm lol

P.S.S.
Work most correctly with russian numbers, I was decide not touch this.
*/
...
export default class PhoneMask {
    ...
    formatPhoneNumber(inputNumbersValue) {
        ...
        //There was be 'const' instead of 'let' and its broke all if length of russian number went beyond the limit lol
